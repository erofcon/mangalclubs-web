                ...
                <div className="min-w-0 space-y-5">
                    <section
                        ...
                        <div className="flex min-w-0 flex-col gap-5 sm:gap-6 md:flex-row md:items-center">
                            <div className="relative h-28 w-28 shrink-0 rounded-full bg-background sm:h-37.5 sm:w-37.5">
                ...
                <aside className="order-first w-full min-w-0 pt-1 text-text lg:order-0">
                    <nav
                        ...
                        <a
                            href="#"
                            className="min-w-0
                            flex-1 basis-[calc(50%-0.25rem)]
                            rounded-full
                            bg-text
                            py-2
                            text-center text-text-on-primary
                             wrap-break-word lg:block
                        ...
                        <a
                            ...
                            rounded-full
                            bg-card py-2
                            text-center wrap-break-word lg:block
                             hover:scale-105 duration-200"
                        >
                            Заказы
                        </a>
